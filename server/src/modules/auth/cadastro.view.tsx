						...
						<div class="form-grid">
							...
							<div class="field">
								...
								<div class="input-senha-wrapper">
									...
									>
										<svg
											class="icone-olho icone-fechado"
											viewBox="0 0 24 24"
											fill="none"
								...
								<ul class="senha-requisitos" id="senha-requisitos" hidden>
									<li data-regra="tamanho">
										<span class="icone">✗</span> Mínimo de 8 caracteres
									</li>
									<li data-regra="maiuscula">
										<span class="icone">✗</span> Letra maiúscula
									</li>
									<li data-regra="minuscula">
										<span class="icone">✗</span> Letra minúscula
									</li>
									<li data-regra="numero">
										<span class="icone">✗</span> Número
									</li>
									<li data-regra="especial">
										<span class="icone">✗</span> Caractere especial
									</li>
								</ul>
							</div>
							...
							<div class="field">
								...
								<ul
									class="senha-requisitos confirmacao-senha"
									aria-live="polite"
								>
