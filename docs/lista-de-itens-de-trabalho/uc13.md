...
- **FA-2A — Nenhum progresso registrado**
...
- **FE-E1 — Falha ao recuperar os dados do usuário**
...
- **FE-E2 — Erro no cálculo do progresso das insígnias**
...
- **FE-E3 — Falha ao carregar a interface de exibição das insígnias**
