...
<img src="../assets/prototipos/extrato/prototipo_extrato_baixa.png" alt="Wireframe do caso de uso UC09" width="100%">
<img src="../assets/prototipos/extrato/prototipo_extrato_tablet_baixa.png" alt="Wireframe do caso de uso UC09" width="50%">
<img src="../assets/prototipos/extrato/prototipo_extrato_mobile_baixa.png" alt="Wireframe do caso de uso UC09" width="33%">


#### Alta fidelidade (Mockups)

<img src="../assets/prototipos/extrato/prototipo_extrato.png" alt="Wireframe do caso de uso UC09" width="100%">
<img src="../assets/prototipos/extrato/prototipo_extrato_tablet.png" alt="Wireframe do caso de uso UC09" width="50%">
<img src="../assets/prototipos/extrato/prototipo_extrato_mobile.png" alt="Wireframe do caso de uso UC09" width="33%">
