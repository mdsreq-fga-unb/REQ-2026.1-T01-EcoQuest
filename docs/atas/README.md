# 8. Atas, Entrevistas, Brainstormings e Validações

Este diretório centraliza as evidências das atividades de Engenharia de Requisitos executadas com a cliente e stakeholders.

## 8.1 Histórico de Interações
...
| 30/06/2026 | Validação da conclusão funcional do MVP | Assíncrona | Prof. Juliana, João Victor | [Ata 30-06](/atas/30-06.md) |

## 8.2 Feedbacks e Decisões de Stakeholders

### Feedbacks registráveis

- Terminologia de domínio refinada: adoção de "descarte sustentável e responsável" e "resíduos potencial contaminantes".
- Priorização do MVP para gamificação e engajamento.
- Validação de identidade visual com comparação entre alternativas verde e laranja.
- Validação contínua de wireframes de insígnias, prêmios, navegação, ranking e simulação de descarte.

### Decisões e rastreabilidade para artefatos
...
- Validação e feedback com stakeholders: [Ata 16-05](/atas/16-05.md), [Ata 17-05](/atas/17-05.md), [Ata 04-06 (Validação)](/atas/04-06-validacao.md), [Ata 12-06](/atas/12-06.md), [Ata 30-06](/atas/30-06.md)

## Histórico de Versão

| Data | Versão | Descrição da Alteração | Autor(a) |
|---|---|---|---|
| 12/06/2026 | 1.0 | Centralização das atas e inclusão de evidências de entrevistas, brainstormings e validações. | João Victor |
| 14/06/2026 | 1.1 | Inclusão do mecanismo de monitoramento quinzenal da execução das atividades de ER. | João Victor |
| 01/07/2026 | 1.2 | Inclusão de evidências de validação do conclusão funcional do MVP. | João Victor |